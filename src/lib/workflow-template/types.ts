...
export const WORKFLOW_TEMPLATE_API_VERSION = 'csiharness.io/v1alpha1' as const;
export const LEGACY_WORKFLOW_TEMPLATE_API_VERSION = 'aceharness.io/v1alpha1' as const;
...
export const workflowTemplateManifestSchema = z.object({
  apiVersion: z.union([
    z.literal(WORKFLOW_TEMPLATE_API_VERSION),
    z.literal(LEGACY_WORKFLOW_TEMPLATE_API_VERSION),
  ]),
  ...
  spec: {
    ...manifest.spec,
    compatibility: {
      csiharness: manifest.spec.compatibility.csiharness
        || manifest.spec.compatibility.aceharness,
    },
  },
}));
