import { type LanguageRegistration } from 'shiki'
 ...
 // Cangjie language grammar definition
export const cangjieGrammar: LanguageRegistration = {
  name: 'cangjie',
  scopeName: 'source.cj',
  aliases: ['cj'],
  patterns: [
  ...
  repository: {
    ...
    'classlike-declaration': {
      patterns: [
        {
          match: '\\b(enum)\\s+(`?[\\p{XID_Start}][\\p{XID_Continue}]*`?)(\\s*)(<)',
          captures: {
            '1': { name: 'keyword.declaration.type.Cangjie' },
            '2': { name: 'entity.name.type.Cangjie' },
            '4': { name: 'punctuation.separator.Cangjie' }
          }
        },
        {
          match: '\\b(class|interface|struct|enum|extend|type)\\s+(`?[\\p{XID_Start}][\\p{XID_Continue}]*`?)(\\s*)(<)',
          captures: {
            '1': { name: 'keyword.declaration.type.Cangjie' },
            '2': { name: 'entity.name.type.Cangjie' },
            '4': { name: 'punctuation.separator.Cangjie' }
      ...
      patterns: [
        {
          ...
          captures: {
            '1': { name: 'keyword.control.Cangjie' },
            '2': { name: 'entity.name.tag.annotation.Cangjie' }
          }
        }
      ]
    },
    constructor: {
      patterns: [
        ...
        {
          name: 'constant.language.Cangjie',
          match: '\\b[\\p{Lu}][\\p{XID_Continue}]*(?=\\s*\\<[\\*\\<\\,\\w\\s]*\\>\\s*\\()'
        }
      ]
    },
    function: {
    ...
    variable: {
      patterns: [
        {
          name: 'constant.language.boolean.Cangjie',
          match: '\\b(true|false)\\b'
        },
        {
          match: '((=|[+\\-*/%^]=|&&=|\\|\\|=|&=|\\|=)(\\s*))(`?[a-z_][\\p{XID_Continue}]*`?)(\\.)(`?[\\p{Lu}][\\p{XID_Continue}]*`?)(?=\\s*(//|<|\\(|\\||,|\\)|\\]|\\}|:|;|\\.|$))',
          captures: {
            '4': { name: 'support.variable.Cangjie' },
            '5': { name: 'punctuation.separator.Cangjie' },
            '6': { name: 'constant.language.Cangjie' }
          }
        },
        {
          match: '((=|[+\\-*/%^]=|&&=|\\|\\|=|&=|\\|=)(\\s*))(`?[\\p{Lu}][\\p{XID_Continue}]*`?)(\\s*)(<(?:[^>\\n]|->)+>)(\\.)(`?[\\p{Lu}][\\p{XID_Continue}]*`?)(?=\\s*(//|<|\\(|\\||,|\\)|\\]|\\}|:|;|\\.|$))',
          captures: {
            '4': { name: 'entity.name.type.Cangjie' },
            '6': { name: 'entity.name.type.Cangjie' },
            '7': { name: 'punctuation.separator.Cangjie' },
            '8': { name: 'constant.language.Cangjie' }
          }
        },
        {
          match: '((=|[+\\-*/%^]=|&&=|\\|\\|=|&=|\\|=)(\\s*))(`?[\\p{Lu}][\\p{XID_Continue}]*`?)(\\.)(`?[\\p{Lu}][\\p{XID_Continue}]*`?)(?=\\s*(//|<|\\(|\\||,|\\)|\\]|\\}|:|;|\\.|$))',
          captures: {
            '4': { name: 'entity.name.type.Cangjie' },
            '5': { name: 'punctuation.separator.Cangjie' },
            '6': { name: 'constant.language.Cangjie' }
        ...
        {
          match: '((=|[+\\-*/%^]=|&&=|\\|\\|=|&=|\\|=)(\\s*))(?!VArray\\b|Nothing\\b|This\\b|IntNative\\b|UIntNative\\b|Int8\\b|Int16\\b|Int32\\b|Int64\\b|UInt8\\b|UInt16\\b|UInt32\\b|UInt64\\b|Float16\\b|Float32\\b|Float64\\b|Rune\\b|Bool\\b|Unit\\b|String\\b)(`?[\\p{Lu}][\\p{XID_Continue}]*`?)(?=\\s*(//|\\(|\\||,|\\)|\\]|\\}|:|;|$))',
          captures: {
            '4': { name: 'constant.language.Cangjie' }
          }
        },
        {
          match: '((=|[+\\-*/%^]=|&&=|\\|\\|=|&=|\\|=)(\\s*))(`?[\\p{XID_Start}][\\p{XID_Continue}]*`?)(?=\\s*\\<(?:[^>\\n]|->)*\\>\\s*~>)',
          captures: {
            '4': { name: 'support.function.Cangjie' }
          }
        },
        {
          match: '((=|[+\\-*/%^]=|&&=|\\|\\|=|&=|\\|=)(\\s*))(`?[\\p{XID_Start}][\\p{XID_Continue}]*`?)(?=\\s*~>)',
      ...
      patterns: [
        {
          begin: '\\b(package)\\b\\s*',
          beginCaptures: {
            '1': { name: 'keyword.control.package.Cangjie' }
          },
          end: '(?=[^.\\w\\s])|\\R|\\Z|\\n',
          endCaptures: {
            '1': { name: 'punctuation.terminator.Cangjie' }
          },
          name: 'keyword.control.Cangjie',
      ...
      patterns: [
        {
          ...
          endCaptures: {
            '1': { name: 'punctuation.definition.string.end.Cangjie' }
          },
      ...
      patterns: [
        {
          ...
          beginCaptures: {
            '1': { name: 'keyword.control.import.Cangjie' }
          },
