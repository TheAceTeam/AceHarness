/**
 * Wrap content in HTML <pre><code> for use inside HTML blocks like <details>.
 * Escapes HTML entities so content renders safely.
 */
export function htmlCodeBlock(content: string, lang = ''): string {
