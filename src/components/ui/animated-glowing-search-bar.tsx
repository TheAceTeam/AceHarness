    ...
    <div className={cn('relative flex min-w-0 items-center justify-center', className)}>
      <div id="poda" className="office-search-shell group relative flex w-full min-w-0 items-center justify-center">
        ...
        <div id="main" className="group relative w-full min-w-0">
          ...
          <div className="absolute right-[7px] top-[7px] h-[42px] w-10 overflow-hidden rounded-lg before:absolute before:left-1/2 before:top-1/2 before:h-[600px] before:w-[600px] before:-translate-x-1/2 before:-translate-y-1/2 before:animate-spin before:rotate-90 before:bg-[conic-gradient(rgba(0,0,0,0),#3d3a4f,rgba(0,0,0,0)_50%,rgba(0,0,0,0)_50%,#3d3a4f,rgba(0,0,0,0)_100%)] before:bg-no-repeat before:brightness-[1.35] before:content-['']" />
          <div id="filter-icon" className="absolute right-2 top-2 z-[2] flex h-full max-h-10 w-full max-w-[38px] items-center justify-center overflow-hidden rounded-lg border border-transparent bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] [isolation:isolate]">
