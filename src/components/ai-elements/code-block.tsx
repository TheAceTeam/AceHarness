...
// Common languages that are definitely bundled with Shiki
const KNOWN_BUNDLED_LANGUAGES = new Set([
  "text", "plaintext", "txt",
...
export const CodeBlockContent = ({
  ...
  const language = normalizeLang(rawLanguage as string);
